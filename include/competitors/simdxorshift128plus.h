...
* typedef struct {
*     __m256i s[2];
* } simdxorshift128plus_state;
* 
* void simdxorshift128plus_init(simdxorshift128plus_state* state, uint64_t seed1, uint64_t seed2);
* __m256i simdxorshift128plus_next(simdxorshift128plus_state* state);
* uint64_t simdxorshift128plus_next_u64(simdxorshift128plus_state* state);
*/
